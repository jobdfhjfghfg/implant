...
| 기능 목록 | 상세 기능 |
| :----: | :----: |
|  회원 기능 <br><hr>  <br> 제품 등록 기능 <hr><br>출고 기능<br><hr> 공정현황 <br><hr> | 1. 회원가입 <br> 2. 로그인 <br><hr> 1. 원재료 등록 <br> 2. 제품 재고 확인 <br><hr> 3. BOM 등록 및 조회 <br><hr> 1. 제품 출고 <br><hr> 1. 공정별 에러 확인 <br> 2. 에러율 확인 <br><hr>
</div>
